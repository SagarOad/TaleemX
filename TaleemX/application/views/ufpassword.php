    ...
    <body class="ss-no-bg">
        <div class="ss-auth">
                ...
                <div class="ss-auth__panel-inner">
                    <div class="ss-auth-brand">
                        <img class="ss-auth-brand__logo"
                             ...
                             alt="<?php echo html_escape($app_name[0]['name']); ?>">
                    ...
                    <form action="<?php echo site_url('site/ufpassword') ?>" method="post" class="ss-auth-form login-form">
                        ...
                        <div class="ss-auth-field">
                            <div class="ss-auth-input ss-auth-choice">
                                <label class="radio-inline ss-auth-choice__item">
                            ...
                            <?php if (form_error('user[]')) { ?>
                                <span class="ss-auth-field__error"><?php echo form_error('user[]'); ?></span>
                            <?php } ?>
                        </div>
                    ...
                    <div class="ss-auth-link__row">
                        <a href="<?php echo site_url('site/userlogin') ?>" class="ss-auth-link forgot">
                            <i class="fa fa-key"></i> <?php echo $this->lang->line('user_login'); ?>
                        </a>
                    </div>
                </div>
            </section>
            ...
            <aside class="ss-auth__visual"
                   style="background-image: url('<?php echo base_url(); ?>uploads/school_content/login_image/<?php echo $app_name[0]['user_login_page_background']; ?>');">
