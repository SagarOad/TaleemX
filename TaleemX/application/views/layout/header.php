...
<html <?php echo $this->customlib->getRTL(); ?>>
  ...
  <style type="text/css">
        ...
        /* Hide leftover license notification strip on admin dashboard top area */
        .content-wrapper .content > div:first-child > .dashalert.alert.alert-success,
        .content-wrapper .content > div:first-child > .alert.alert-success.alert-dismissible,
        .content-wrapper .content > div:first-child > .alert.alert-success:empty {
