...
<style type="text/css">
    /* Quick Links dropdown: lock theme to brown bg + white text */
    .fixedmenu .dropdown-menu.verticalmenu.side-navbar-vertical,
    ...
    .fixedmenu .dropdown-menu.verticalmenu.side-navbar-vertical .card-sidebar h4,
    .fixedmenu .dropdown-menu.verticalmenu.side-navbar-vertical .card-sidebar h4 i,
    .fixedmenu .dropdown-menu.verticalmenu.side-navbar-vertical .card-sidebar ul li a {
        color: #ffffff !important;
        opacity: 1 !important;
        text-shadow: none !important;
    }

    .fixedmenu .dropdown-menu.verticalmenu.side-navbar-vertical .card-sidebar ul {
        border-bottom-color: rgba(255, 255, 255, 0.20) !important;
    }

    .fixedmenu .dropdown-menu.verticalmenu.side-navbar-vertical .card-sidebar ul li a:hover,
    .fixedmenu .dropdown-menu.verticalmenu.side-navbar-vertical .card-sidebar ul li a:focus {
        color: #ffffff !important;
