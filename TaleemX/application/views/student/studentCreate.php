...
<style>
/* ===== Student Admission — Modern UI (visual-only, no field/functionality changes) ===== */
.sa-page-title{font-size:22px;font-weight:700;color:#1f1f1f;margin:0 0 16px 2px;letter-spacing:.2px;}
.sa-card{background:#fff;border:1px solid #ececec;border-radius:12px;box-shadow:0 2px 10px rgba(0,0,0,.04);padding:22px 26px;margin-bottom:20px;}
.sa-section-head{display:flex;align-items:center;justify-content:space-between;gap:12px;margin:6px 0 18px;}
.sa-section-head h4.pagetitleh2{font-size:15px;font-weight:700;color:#222;margin:0;padding:0;border:0;background:transparent;display:flex;align-items:center;gap:8px;}
.sa-section-head h4.pagetitleh2 i.sa-ic{width:22px;height:22px;display:inline-flex;align-items:center;justify-content:center;border-radius:6px;background:#f5efe8;color:#7a4b2a;font-size:12px;}
.sa-section-head .sa-section-right{display:flex;align-items:center;gap:10px;}

/* Strip the old box header styling, rely on sa-card */
.content-wrapper .box.box-primary{background:transparent;border:0;box-shadow:none;margin-bottom:140px;}
.content-wrapper .box.box-primary > form > div > .bozero{background:#fff;border:1px solid #ececec;border-radius:12px;box-shadow:0 2px 10px rgba(0,0,0,.04);padding:18px 22px;margin-bottom:18px;}
.content-wrapper .box.box-primary > form > div > .bozero .around10{padding:0;}

/* Ensure every pagetitleh2 (section heading) looks modern */
h4.pagetitleh2{font-size:15px !important;font-weight:700 !important;color:#222 !important;border:0 !important;background:transparent !important;padding:0 !important;margin:4px 0 14px !important;display:flex;align-items:center;gap:8px;}
h4.pagetitleh2::before{content:"";display:inline-block;width:4px;height:16px;background:#7a4b2a;border-radius:2px;margin-right:4px;}

/* Inputs */
.sa-card .form-control,.bozero .form-control{border:1px solid #e3e3e3;border-radius:8px;height:40px;background:#fff;box-shadow:none;transition:border-color .15s, box-shadow .15s;}
.sa-card .form-control:focus,.bozero .form-control:focus{border-color:#7a4b2a;box-shadow:0 0 0 3px rgba(122,75,42,.12);}
.sa-card textarea.form-control,.bozero textarea.form-control{height:auto;min-height:80px;}
.form-group label{font-size:12.5px;color:#4b4b4b;font-weight:600;margin-bottom:6px;}

/* Student Photo — centered circular uploader above personal details fields */
.sa-avatar-wrap{display:flex;flex-direction:column;align-items:center;justify-content:center;padding:6px 0 14px;}
.sa-avatar{width:110px;height:110px;border-radius:50%;background:#f1ece6;display:flex;align-items:center;justify-content:center;color:#b18b6a;font-size:46px;border:1px dashed #d9cdbf;overflow:hidden;}
.sa-avatar img{width:100%;height:100%;object-fit:cover;}
.sa-avatar-preview{display:none;}
.sa-photo-col .form-group > label{display:none;} /* hide default label since we add our own */
.sa-photo-col{display:flex;justify-content:center;}
.sa-photo-col .form-group{width:auto;text-align:center;}
/* The #image input is enhanced by Dropify (not bootstrap-filestyle).
   Hide Dropify's built-in preview/filename so the rectangle shows only the
   drag-and-drop message; the uploaded image is previewed in the circle avatar. */
.sa-photo-col .dropify-preview{display:none !important;}
.sa-photo-col .dropify-filename{display:none !important;}
.sa-photo-col .dropify-wrapper.has-preview .dropify-message{display:block !important;}
.sa-photo-col .dropify-wrapper .dropify-clear{display:none !important;}
...
.addmoredetail-title{
    background:linear-gradient(180deg,#faf5ef 0%,#f5efe8 100%);
    border:1px solid #e6d9cc;
    border-radius:12px;
    padding:4px 12px;
    margin:0 5px;
    box-shadow:0 1px 4px rgba(58,42,31,.06);
}
.addmoredetail-title .boxplus{
    width:100%;
    display:flex;
    align-items:center;
...
.addmoredetail-title .boxplus:hover{color:#2e2118 !important;}

/* Save footer */
.sa-footer{display:flex;justify-content:flex-end;padding:10px 2px 40px;}
.sa-footer .btn-save{background:#3a2a1f;color:#fff;border:0;border-radius:8px;padding:10px 28px;font-weight:600;font-size:13px;}
.sa-footer .btn-save:hover{background:#4a3628;color:#fff;}
@media (max-width:767px){
    .sa-footer{padding-bottom:52px;}
    .content-wrapper .box.box-primary{margin-bottom:160px;}
}

/* Import Student top-right button */
.sa-import-btn{background:#3a2a1f;color:#fff;border:0;border-radius:8px;padding:8px 16px;font-weight:600;font-size:13px;}
.sa-import-btn:hover{background:#4a3628;color:#fff;}

/* Panels inside fees details subtler look */
.panel-group1 .panel-heading{background:#fafafa;border-radius:8px;}
</style>
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <h2 class="sa-page-title"><?php echo $this->lang->line('student'); ?> <?php echo $this->lang->line('admission'); ?></h2>
                <div class="box box-primary">
                    <div class="box-header ptbnull" style="display:none;">
                            ...
                            <div class="bozero">
								...
								?>
                                    ...
                                    <div class="sa-section-head">
                                        <h4 class="pagetitleh2"><i class="sa-ic fa fa-user"></i> <?php echo $this->lang->line('personal_details') ? $this->lang->line('personal_details') : 'Personal Details'; ?></h4>
                                        <div class="sa-section-right">
                                            <?php if ($this->rbac->hasPrivilege('import_student', 'can_view')) {?>
                                            <a href="<?php echo site_url('student/import') ?>">
                                                <button type="button" class="sa-import-btn"><i class="fa fa-upload"></i>
                                    ...
                                    <div class="sa-avatar-wrap sa-photo-col">
                                        <div class="sa-avatar">
                                            <i class="fa fa-user sa-avatar-icon"></i>
                                            <img src="" alt="Student photo preview" class="sa-avatar-preview">
                                        </div>
                                        <div class="form-group" style="margin:10px 0 0;text-align:center;">
                                            <input class="filestyle form-control" type='file' name='image' id="image"
                                                size='20' />
...
?>
                      ...
                      <?php   if ($sch_setting->student_form_multi_class=='enabled') { ?>
                        <div class="bozero">
                            <div class="relative">
                                <h4 class="pagetitleh2"><i class="sa-ic fa fa-users"></i>
...
if ($this->module_lib->hasActive('transport')) {
        ?>
                        <div class="bozero">
                            <h4 class="pagetitleh2"><i class="sa-ic fa fa-bus"></i>
...
if ($this->module_lib->hasActive('hostel')) {
        ?>
            ...
            ?>
                        <div class="bozero">
                            <h4 class="pagetitleh2"><i class="sa-ic fa fa-building"></i>
...
?>
                        <div class="mainstudent">
                            ...
                            <h4 class="pagetitleh2"><i class="sa-ic fa fa-money"></i>
...
?>
                        ...
                        <div class="mainstudent discount_div">
                            ...
                            <h4 class="pagetitleh2"><i class="sa-ic fa fa-tag"></i><?php echo $this->lang->line('fees_discount_details'); ?>
    ...
    if (!empty($feediscountList)) {  ?>
            ...
            foreach($feediscountList as $key=>$feediscount){  ?>
                ...
                ?>
                        ...
                        <div class="bozero">
                            <h4 class="pagetitleh2"><i class="sa-ic fa fa-users"></i><?php echo $this->lang->line('parent_guardian_detail'); ?></h4>
                            <div class="around10">
                                <div class="row">
                            ...
                            <div class="panel box collapsed-box border0 mb0">
                                ...
                                <div class="box-body">
                                    <div class="mb25 bozero">
                                        <h4 class="pagetitleh2"><i class="sa-ic fa fa-map-marker"></i>
                                    ...
                                    <div class="tshadow mb25 bozero">
                                        <h4 class="pagetitleh2"><i class="sa-ic fa fa-info-circle"></i>
...
echo set_value('rte') == "no" ? "checked" : "";
    ?>><?php echo $this->lang->line('no'); ?></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="tshadow bozero">
                                                    <h4 class="pagetitleh2"><i class="sa-ic fa fa-folder"></i>
                        ...
                        <div class="sa-footer">
                            <button type="submit" class="btn btn-info pull-right btn-save"
...
$(document).ready(function() {
    ...
    $(document).on('change', '#image', function() {
        ...
        var previewImage = $('.sa-avatar-preview');
        var previewIcon = $('.sa-avatar-icon');
