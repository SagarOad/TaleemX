...
foreach ($notifications as $notice_key => $notice_value) {
    $notice_title = isset($notice_value->title) ? strtolower(trim(strip_tags($notice_value->title))) : '';
    $is_license_notice = (
        strpos($notice_title, 'unregistered version') !== false
        || strpos($notice_title, 'purchase code') !== false
        || strpos($notice_title, 'register your purchase code') !== false
    );
    if ($is_license_notice) {
        continue;
    }
        ...
        ?>
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart">
                            <p class="mt5 clearfix font14"><i class="fa ftlayer ss-kpi-icon ss-kpi-icon-fees"></i><?php echo $this->lang->line('fees_awaiting_payment'); ?><span class="pull-right"><?php echo $total_paid; ?>/<?php echo $total_fees ?></span>
                            </p>
        ...
        ?>
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart shadow">
                            <p class="mt5 font14"><i class="fa ftlayer ss-kpi-icon ss-kpi-icon-staff-leave"></i><?php echo $this->lang->line('staff_approved_leave'); ?><span class="pull-right"><?php echo ($getStaffApproveMonthlyLeave) + 0; ?>/<?php echo ($getStaffMonthlyLeave); ?></span>
                            </p>
                            <div class="progress-group">
                                <div class="progress progress-minibar">
...
<?php 
    if ($this->rbac->hasPrivilege('student_approved_leave_widegts', 'can_view')) {
        ?>
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart shadow">
                            <p class="mt5 font14"><i class="fa ftlayer ss-kpi-icon ss-kpi-icon-student-leave"></i><?php echo $this->lang->line('student_approved_leave'); ?><span class="pull-right"><?php echo ($getStudentApproveMonthlyLeave) + 0; ?>/<?php echo ($getStudentMonthlyLeave); ?></span>
                            </p>
                            <div class="progress-group">
                                <div class="progress progress-minibar">
...
if ($this->module_lib->hasActive('front_office')) {
    if ($this->rbac->hasPrivilege('conveted_leads_widegts', 'can_view')) {
        ?>
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart">
                            <p class="mt5 clearfix font14"><i class="fa ftlayer ss-kpi-icon ss-kpi-icon-converted-leads"></i><?php echo $this->lang->line('converted_leads'); ?><span class="pull-right"><?php echo $total_complete + 0; ?>/<?php echo $total_enquiry; ?></span>
                            </p>
                            <div class="progress-group">
                                <div class="progress progress-minibar">
...
if ($this->rbac->hasPrivilege('staff_present_today_widegts', 'can_view')) {
    ?>
                <div class="<?php echo $std_graphclass; ?>">
                    <div class="topprograssstart">
                        <p class="mt5 clearfix font14"><i class="fa ftlayer ss-kpi-icon ss-kpi-icon-staff-present"></i><?php echo $this->lang->line('staff_present_today'); ?><span class="pull-right"><?php echo $Staffattendence_data + 0; ?>/<?php echo $getTotalStaff_data; ?></span>
                        </p>
                        <div class="progress-group">
                            <div class="progress progress-minibar">
...
if ($this->module_lib->hasActive('student_attendance') && $sch_setting->attendence_type == 0) {
    if ($this->rbac->hasPrivilege('student_present_today_widegts', 'can_view')) {
        ?>
                    <div class="<?php echo $std_graphclass; ?>">
                        <div class="topprograssstart">
                            <p class="mt5 clearfix font14"><i class="fa ftlayer ss-kpi-icon ss-kpi-icon-student-present"></i><?php echo $this->lang->line('student_present_today'); ?><span class="pull-right"> <?php echo 0 + $attendence_data['total_half_day'] + $attendence_data['total_late'] + $attendence_data['total_present']; ?>/<?php echo $total_students; ?></span>
                            </p>
                            <div class="progress-group">
                                <div class="progress progress-minibar">
                    ...
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa ss-chart-icon ss-chart-icon-left"></i><?php echo $this->lang->line('fees_collection_expenses_for'); ?> <?php echo $this->lang->line(strtolower(date('F'))) . " " . date('Y');
    ...
    if ($this->rbac->hasPrivilege('income_donut_graph', 'can_view')) {
        ?>
                    <div class="col-lg-5 col-md-5 col-sm-12 col40">
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border"><h3 class="box-title"><i class="fa ss-chart-icon ss-chart-icon-right"></i><?php echo $this->lang->line('income') . " - " . $this->lang->line(strtolower(date('F'))) . " " . date('Y');  ?></h3></div>
                            <div class="box-body">
        ...
        ?>
                    <div class="col-lg-7 col-md-7 col-sm-12 col60">
                        <div class="box box-info borderwhite">
                            <div class="box-header with-border">
                                <h3 class="box-title"><i class="fa ss-chart-icon ss-chart-icon-left"></i><?php echo $this->lang->line('fees_collection_expenses_for_session'); ?> <?php echo $this->setting_model->getCurrentSessionName(); ?></h3>
...
if ($this->module_lib->hasActive('expense')) {
    ...
    <?php if ($this->rbac->hasPrivilege('expense_donut_graph', 'can_view')) {
        ?>
                    <div class="col-lg-5 col-md-5 col-sm-12 col40">
                        <div class="box box-primary borderwhite">
                            <div class="box-header with-border"><h3 class="box-title"><i class="fa ss-chart-icon ss-chart-icon-right"></i><?php echo $this->lang->line('expense') . " - " . $this->lang->line(strtolower(date('F'))) . " " . date('Y');  ?></h3>
                            </div><!--./info-box-->
                            <div class="box-body">
                                <div class="chart-responsive">
...
?>
             ...
             <div class="row ss-dash-stats-row">
                
<?php
if ($this->module_lib->hasActive('fees_collection')) {
    if ($this->rbac->hasPrivilege('Monthly fees_collection_widget', 'can_view')) {
        ?>
                                <div class="col-lg-3 col-md-6 col-sm-6 ss-dash-stat-fees">
                                    <div class="info-box">
                                        <a href="<?php echo site_url('studentfee') ?>">
                                            <span class="info-box-icon"><i class="fa ss-stat-icon ss-stat-icon-fees"></i></span>
...
if ($this->module_lib->hasActive('expense')) {
    if ($this->rbac->hasPrivilege('monthly_expense_widget', 'can_view')) {
        ?>
                                <div class="col-lg-3 col-md-6 col-sm-6 ss-dash-stat-expense">
                                    <div class="info-box">
                                        <a href="<?php echo site_url('admin/expense') ?>">
                                            <span class="info-box-icon"><i class="fa ss-stat-icon ss-stat-icon-expense"></i></span>
                                            <div class="info-box-content">
...
if ($this->rbac->hasPrivilege('student_count_widget', 'can_view')) {
    ?>
                            <div class="col-lg-3 col-md-6 col-sm-6 ss-dash-stat-students">
                                <div class="info-box">
                                    <a href="<?php echo site_url('student/search') ?>">
                                        <span class="info-box-icon"><i class="fa ss-stat-icon ss-stat-icon-student"></i></span>
                                        <div class="info-box-content">
...
<!-- added new features -->
   <?php if ($this->rbac->hasPrivilege('student_head_count_widget', 'can_view')) {  ?>
                            <div class="col-lg-3 col-md-6 col-sm-6 ss-dash-stat-heads">
                                <div class="info-box">
                                    <a href="<?php echo site_url('student/search') ?>">
                                        <span class="info-box-icon"><i class="fa ss-stat-icon ss-stat-icon-head-count"></i></span>
                                        <div class="info-box-content">
...
if ($this->rbac->hasPrivilege('staff_role_count_widget', 'can_view')) {
    ...
    foreach ($roles as $key => $value) {
        $ss_role_mod = $ss_dash_role_i % 4;
        $ss_dash_role_i++;
        $ss_role_slug = strtolower(trim(preg_replace('/[^a-z0-9]+/i', '-', $key), '-'));
        ?>
                    <div class="col-lg-3 col-md-6 col-sm-6 ss-dash-stat-role ss-dash-stat-role--<?php echo (int) $ss_role_mod; ?>">
    
                            <div class="info-box">
                                <a href="#">
                                    <span class="info-box-icon"><i class="fa ss-stat-icon ss-stat-icon-role ss-stat-icon-role-<?php echo html_escape($ss_role_slug); ?>"></i></span>
                                    <div class="info-box-content">
...
if ($this->rbac->hasPrivilege('fees_collection_and_expense_yearly_chart', 'can_view')) {
        ...
        labels: total_month,
                ...
                {
                label: "Expense",
                        fillColor: "rgba(185, 28, 28, 0.55)",
                        strokeColor: "rgba(153, 27, 27, 0.9)",
                        pointColor: "rgba(127, 29, 29, 0.95)",
             ...
             <?php if(($this->module_lib->hasActive('income'))){?> 
                ...
                label: "Collection",
                        ...
                        pointColor: "rgba(248, 113, 113, 0.95)",
                        pointStrokeColor: "rgba(220, 38, 38, 0.7)",
                        pointHighlightFill: "#fff",
                        pointHighlightStroke: "rgba(220, 38, 38, 0.6)",
        ...
        labels: current_month_days,
                ...
                label: "Electronics",
                        ...
                        pointStrokeColor: "#c1c7d1",
                        pointHighlightFill: "#fff",
                        pointHighlightStroke: "rgba(220, 38, 38, 0.5)",
                        data: days_collection
                },
				<?php }if(($this->module_lib->hasActive('expense'))){?>											   
                {
                label: "Digital Goods",
                        fillColor: "rgba(185, 28, 28, 0.75)",
                        strokeColor: "rgba(153, 27, 27, 0.95)",
                        pointColor: "rgba(127, 29, 29, 0.95)",
                        pointStrokeColor: "rgba(127, 29, 29, 0.9)",
                        pointHighlightFill: "#fff",
                        pointHighlightStroke: "rgba(153, 27, 27, 0.6)",
                        data: days_expense
                }
				<?php } ?> 
                ]
        ...
        labels: current_month_days,
                ...
                {
                label: "Digital Goods",
                        fillColor: "rgba(185, 28, 28, 0.8)",
                        strokeColor: "rgba(153, 27, 27, 0.95)",
                        pointColor: "rgba(127, 29, 29, 0.95)",
                        pointStrokeColor: "rgba(127, 29, 29, 0.9)",
                        pointHighlightFill: "#fff",
                        pointHighlightStroke: "rgba(153, 27, 27, 0.55)",
                        data: days_expense
                }
				<?php } ?> 
                ]
