            ...
            <section class="ss-auth__panel">
                <div class="ss-auth__panel-inner">
                    ...
                    <?php if ($this->session->flashdata('disable_message')) { ?>
                        <div class="ss-auth-alert ss-auth-alert--danger"><?php echo $this->session->flashdata('disable_message'); ?></div>
                        <?php $this->session->unset_userdata('disable_message'); ?>
                    <?php } ?>

                    <form action="<?php echo site_url('site/login') ?>" method="post" class="ss-auth-form login-form">
                            ...
                            <div class="ss-auth-input">
                                <span class="ss-auth-input__icon" aria-hidden="true">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M17 20.5H7C4 20.5 2 19 2 15.5V8.5C2 5 4 3.5 7 3.5H17C20 3.5 22 5 22 8.5V15.5C22 19 20 20.5 17 20.5Z" fill="#442F24"/>
                                        <path d="M12 12.87C11.16 12.87 10.31 12.61 9.66003 12.08L6.53002 9.57997C6.21002 9.31997 6.15003 8.84997 6.41003 8.52997C6.67003 8.20997 7.14003 8.14997 7.46003 8.40997L10.59 10.91C11.35 11.52 12.64 11.52 13.4 10.91L16.53 8.40997C16.85 8.14997 17.33 8.19997 17.58 8.52997C17.84 8.84997 17.79 9.32997 17.46 9.57997L14.33 12.08C13.69 12.61 12.84 12.87 12 12.87Z" fill="#442F24"/>
                                    </svg>
                                </span>
                                <input type="text"
                                       id="form-username"
                        ...
                        <div class="ss-auth-field">
                            <label class="sr-only" for="form-password"><?php echo $this->lang->line('password'); ?></label>
                            <div class="ss-auth-input">
                                <span class="ss-auth-input__icon" aria-hidden="true">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.4" d="M9.99994 14.4583C10.7501 14.4583 11.3583 13.8502 11.3583 13.1C11.3583 12.3498 10.7501 11.7416 9.99994 11.7416C9.24975 11.7416 8.6416 12.3498 8.6416 13.1C8.6416 13.8502 9.24975 14.4583 9.99994 14.4583Z" fill="#442F24"/>
                                        <path d="M13.8751 7.86664H6.12508C2.70841 7.86664 1.66675 8.90831 1.66675 12.325V13.875C1.66675 17.2916 2.70841 18.3333 6.12508 18.3333H13.8751C17.2917 18.3333 18.3334 17.2916 18.3334 13.875V12.325C18.3334 8.90831 17.2917 7.86664 13.8751 7.86664ZM10.0001 15.6166C8.60841 15.6166 7.48341 14.4833 7.48341 13.1C7.48341 11.7166 8.60841 10.5833 10.0001 10.5833C11.3917 10.5833 12.5167 11.7166 12.5167 13.1C12.5167 14.4833 11.3917 15.6166 10.0001 15.6166Z" fill="#442F24"/>
                                        <path opacity="0.4" d="M5.93327 7.87502V6.90002C5.93327 4.45835 6.62494 2.83335 9.99994 2.83335C13.3749 2.83335 14.0666 4.45835 14.0666 6.90002V7.87502C14.4916 7.88335 14.8749 7.90002 15.2333 7.95002V6.90002C15.2333 4.65002 14.6916 1.66669 9.99994 1.66669C5.30827 1.66669 4.7666 4.65002 4.7666 6.90002V7.94169C5.1166 7.90002 5.50827 7.87502 5.93327 7.87502Z" fill="#442F24"/>
                                    </svg>
                                </span>
                                <input type="password"
                                       id="form-password"
                                ...
                                <button type="button"
                                        ...
                                        data-ss-toggle-password="form-password"
                        ...
                        <div class="ss-auth-link__row">
                            <a href="<?php echo site_url('site/forgotpassword') ?>" class="ss-auth-link forgot">
                                <i class="fa fa-key"></i>
